...
class _RideOngoingWidgetState extends State<RideOngoingWidget> {
  ...
  int currentState = 0;
  Timer? _liveFeesTimer;

  @override
  void initState() {
    super.initState();
    _liveFeesTimer = Timer.periodic(const Duration(seconds: 30), (_) {
      final rideController = Get.find<RideController>();
      if (rideController.tripDetail?.id != null) {
        rideController.getLiveFees(rideController.tripDetail!.id!);
      }
    });
  }
                ...
                child: Column(
                    ...
                    children: [
                      PaymentItemInfoWidget(
                        ...
                        title: 'fare_price'.tr,
                        amount: rideController.getDisplayFareFromTripDetail(
