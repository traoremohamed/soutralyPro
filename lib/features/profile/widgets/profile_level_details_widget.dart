                ...
                value: _calculateProgressValue(
                    _calculateTotalTargetPoint(
                        ...
                        profileController
                            ...
                            0),
                    _calculateTotalTargetPoint(
                        profileController.levelModel?.data?.currentLevel
                                ?.targetedRidePoint ??
                            0,
                        profileController.levelModel?.data?.currentLevel
                                ?.targetedAmountPoint ??
              ...
              Align(
                ...
                child: Text.rich(TextSpan(children: [
                  ...
                  TextSpan(
                    ...
                    style:
                        textBold.copyWith(color: Theme.of(context).hintColor),
                  ),
                ])),
              ),
                ...
                child: Column(
                    ...
                    children: [
                      if ((profileController
                                  .levelModel?.data?.currentLevel?.targetedRide
                                  ?.toInt() ??
                              0) >
                          0)
                        Row(
                                  ...
                                  child: LinearProgressIndicator(
                                    value: _calculateProgressValue(
                                      profileController
                                              ...
                                              ?.rideComplete ??
                                          0,
                                      profileController.levelModel?.data
                      ...
                      if ((profileController.levelModel?.data?.currentLevel
                                  ?.targetedReview
                                  ?.toInt() ??
                              0) >
                          0)
                      ...
                      if ((profileController.levelModel?.data?.currentLevel
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${profileController.levelModel?.data?.completedCurrentLevelTarget?.earningAmount ?? 0} points pour '
