      ...
      return Flexible(
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                Text('other_emergency_number'.tr,
                  ...
                  child: Container(
                    ...
                    child: ListView.separated(
                      ...
                      itemCount: safetyAlertController
                              .otherEmergencyNumberModel?.data?.length ??
                          0,
                            ...
                            child: Row(
                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        Text(DynamicTranslationHelper.translate(
                                            safetyAlertController
                                                .otherEmergencyNumberModel
                                                ?.data?[index]
                                                .title)),
                                        Text(safetyAlertController
                                                .otherEmergencyNumberModel
                                                ?.data?[index]
                                                .number ??
                                            '')
                                      ]),
                                  Image.asset(Images.circularCallIcon,
                                      height: 35, width: 35)
                                ]),
                          ),
                        );
