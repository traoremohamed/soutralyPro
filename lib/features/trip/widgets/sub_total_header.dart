...
class SubTotalHeaderTitle extends StatefulWidget {
  ...
  const SubTotalHeaderTitle(
      {super.key, required this.title, this.width, this.color, this.amount});
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(children: [
          Stack(children: [
            Row(
              mainAxisAlignment: widget.amount != null
            ...
            if (Get.find<RideController>().tripDetail?.driverSafetyAlert !=
                null)
              Align(
                alignment: Alignment.topRight,
                child: Padding(
                  padding: const EdgeInsets.only(
                      right: Dimensions.paddingSizeDefault, top: 10),
                    ...
                    child: InkWell(
                      onTap: () => Get.bottomSheet(
                        ...
                        TripSafetySheetDetailsWidget(
                            tripDetails: Get.find<RideController>().tripDetail),
                ...
                child: Text.rich(
                    TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text:
                                ' ${DateConverter.toFrenchDateTime(Get.find<RideController>().tripDetail!.returnTime)}',
