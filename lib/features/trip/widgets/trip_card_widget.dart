                ...
                child: Column(
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            DateConverter.toFrenchDateTime(tripModel.createdAt),
                            style: textRegular.copyWith(
                              color:
                  ...
                  Row(
                      ...
                      children: [
                        Flexible(
                          child: Text(
                            '${'total'.tr} ${PriceConverter.convertPrice(context, tripModel.paidFare != '0' ? double.parse(tripModel.paidFare ?? '0') : (tripModel.discountActualFare != null && tripModel.discountActualFare! > 0 ? tripModel.discountActualFare! : (((tripModel.couponAmount ?? 0) > 0 || (tripModel.discountAmount ?? 0) > 0) ? ((double.tryParse(tripModel.estimatedFare ?? '0') ?? 0) - (tripModel.couponAmount ?? 0) - (tripModel.discountAmount ?? 0)) : (double.tryParse(tripModel.estimatedFare ?? '0') ?? 0))))}',
                            overflow: TextOverflow.ellipsis,
