          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style:
                    textBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
              ),
            ),
            Padding(
              padding:
            ...
            Text(
              ...
              '${PriceConverter.convertPayablePrice(context, _convertDouble(amountController.text) / Get.find<SplashController>().config!.conversionRate!)}',
