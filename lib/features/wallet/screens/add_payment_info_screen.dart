...
class _AddPaymentInfoScreenState extends State<AddPaymentInfoScreen> {
  ...
  String _localizedMethodFieldLabel(String? inputName) {
    final normalized = (inputName ?? '').toLowerCase().replaceAll(' ', '_');
