...
class RideRepository implements RideRepositoryInterface {
  ...
  @override
  Future<Response> tripStatusUpdate(String status, String id,
      String cancellationCause, String dateTime) async {
  ...
  Future<Response> getLiveFees(String tripId) async {
    return await apiClient
        .getData('${AppConstants.liveFeesUri}?trip_request_id=$tripId');
  }
