...
class _PaymentItemInfoWidgetState extends State<PaymentItemInfoWidget> {
  ...
  String _displayAmount(BuildContext context, double value) {
    return widget.payableRounded
        ? PriceConverter.convertPayablePrice(context, value)
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        widget.isSubTotal || widget.isFromTripDetails
            ? Container(
                ...
                child: Text(
                  _displayAmount(context, widget.amount),
