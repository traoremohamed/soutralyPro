...
class LoginHelper {
  ...
  void checkLoginRoutes(
      Map<String, dynamic>? notificationData, String? userName) {
                ...
                Get.find<LocationController>()
                  ...
                  if (notificationData != null) {
                    NotificationHelper.notificationToRoute(notificationData,
                        formSplash: true, userName: userName);
                  } else {
                    Get.offAll(() => const DashboardScreen());
                    Future.delayed(const Duration(milliseconds: 350), () {
                      DeepLinkService.instance.processPendingRedirect();
                    });
                  }
                });
                PusherHelper()
